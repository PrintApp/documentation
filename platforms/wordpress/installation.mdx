...
<Tip>
    Looking to add **options and live pricing** to your products — sizes,
    materials, quantity breaks, artwork upload? That's our separate
    [Print Options](/print-options/wordpress) product, free on this platform.
</Tip>

<Note>
    For what Print.App actually does inside WooCommerce, including a live editor you can
    try without installing anything, see [Web-to-Print for WooCommerce](https://print.app/web-to-print/woocommerce).
</Note>
