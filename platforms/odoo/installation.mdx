...
1.  Install the module. Two ways:
    -   From the [Odoo Apps Store](https://apps.odoo.com/apps/modules/browse?search=print.app): download the zip for your Odoo version and extract it into your addons directory.
