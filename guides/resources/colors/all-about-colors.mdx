...
By default, colors are provided in substractive RBG mode which are dynamically converted to additive CMYK in the final PDF file through the use of [ICC color profiles](https://print.app/resources/icc-profiles).
