...
Click the red button labelled <span class="bg-rose-500 rounded-full px-3 text-sm text-white">+ Create New Design</span> on the top right corner of the window.
...
<img class="w-96 rounded" src="/images/design-starter.png" />
