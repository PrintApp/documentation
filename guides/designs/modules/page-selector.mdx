...
-   Click the Design tab on the left panel and then click the `Add a Module` button and click Page Selector from the list.
    <img 
            src="/images/page-selector-form.png" 
            alt="Page Selector Module Configuration Form"
            style={{width: "300px"}}
