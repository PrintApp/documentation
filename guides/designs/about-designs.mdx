...
A Print.App Design is a template file with pages containing a combination of Text and Graphics that customers can easily modify with little effort to suit their taste before adding to cart.
...
<Frame caption="The different Design Layers: Underlay, Background, Canvas and Overlay">
...
1.  **Underlay Colors** - 
    ...
    [Learn more here..](/guides/designs/variations/variation-underlay)
...
2.  **Canvas Size** -
    ...
    [Learn more here..](/guides/designs/variations/variation-canvassize)
...
3.  **CSV Datasource** -
    ...
    [Learn more here..](/guides/designs/variations/variation-datasource)
