...
Using the [Resource Profiles](/guides/designs/assign-resources) _(in admin)_, you can  filter and limit resources assigned to a Design.
However, the Preset System takes this function a little further by allowing to filter and limit resources per Object in a design. 

<Note>
    [Click Here to Launch a Live Demo](https://create.print.app/cid_WvxQDG/demo) to see how Presets work.
</Note>
...
- **Graphics**: Curates the images that can be inserted into a [Clipping Mask](/guides/designs/objects/clipping-masks).
