...
**Layout** sets how the Design Editor is arranged for your customers across the whole store: the full studio, a
step-by-step flow, or a view-and-approve screen. You can override it for any single design from the Design panel.

<Tip>
    [See the Layouts guide](/configuration/layouts) for a preview of each layout and how to apply it.
</Tip>
...
**Display Modes** This sets how the editor will display on your store. Currently, we have **Full Window**, **Dialog**, **Inline** and **Mini**
modes.

<Tip>
    [See the Display Modes guide](/configuration/display-modes) for a visual preview of each mode and when to use it.
</Tip>
