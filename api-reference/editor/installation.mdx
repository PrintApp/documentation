...
-   [Odoo](/platforms/odoo/installation/)
-   [Shopware](/platforms/shopware/installation/)
...
<html>
	...
	<script>
		(function() {
			...
			//	Kindly read more here on the options.. https://print.app/docs
			...
			//	You can see a list of all the events here: https://print.app/docs
