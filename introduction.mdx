...
<CardGroup cols={2}>
    <Card href="wordpress/installation" title="Install on Wordpress">
		<img class="rounded-md" src="/images/wp.png" />
    </Card>
    <Card title="Install on Prestashop" href="prestashop/installation">
		<img class="rounded-md" src="/images/ps.png" />
    </Card>
	<Card title="Install on BigCommerce" href="bigcommerce/installation">
		<img class="rounded-md" src="/images/bc.png" />
    </Card>
    <Card title="Install on OpenCart" href="opencart/installation">
